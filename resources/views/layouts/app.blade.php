...
<head>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            /* Aumenta o espaçamento entre ícone e texto no mobile */
...
<body class="bg-body text-body">
    <style>
        ...
        .bi {
            ...
            vertical-align: middle;
            position: relative;
            top: -0.05em; /* Ajuste milimétrico para o centro óptico da maioria das fontes sans-serif */
        }
    ...
    <nav class="navbar navbar-expand-lg border-bottom shadow-sm">
        <div class="container-fluid px-3 px-lg-4">
            <!-- Brand -->
            <a class="navbar-brand navbar-brand-custom d-inline-flex align-items-center gap-2 text-body" href="{{ route('dashboard') }}" style="line-height: 1;">
                <i class="bi bi-shield-check text-primary fs-5" style="transform: translateY(2px);"></i>
            ...
            <div class="collapse navbar-collapse" id="mainNavbar">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 gap-1 mt-3 mt-lg-0">
                    <li class="nav-item">
                        <a class="nav-link nav-link-top {{ request()->routeIs('dashboard') ? 'active' : '' }}" href="{{ route('dashboard') }}" wire:navigate>
                            <i class="bi bi-speedometer2 me-1"></i> Painel
                        </a>
                    </li>
                    @if(auth()->user()->hasRole('admin') && session('admin_mode', true))
                        <li class="nav-item">
                            <a class="nav-link nav-link-top {{ request()->routeIs('admin.users.*') || request()->is('usuarios') ? 'active' : '' }}" href="{{ route('admin.users.index') }}" wire:navigate>
                                <i class="bi bi-people me-1"></i> Usuários
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link nav-link-top {{ request()->routeIs('admin.services') ? 'active' : '' }}" href="{{ route('admin.services') }}" wire:navigate>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-dark shadow border-secondary">
                                <li>
                                    <a class="dropdown-item py-2" href="{{ route('admin.categories') }}" wire:navigate>
                                        <i class="bi bi-tags me-2"></i> Categorias
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item py-2" href="{{ route('admin.logs') }}" wire:navigate>
                                        <i class="bi bi-journal-text me-2"></i> Logs de Atividade
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item py-2" href="{{ route('admin.alerts') }}" wire:navigate>
                    ...
                    @else
                        <li class="nav-item">
                            <a class="nav-link nav-link-top {{ request()->routeIs('front.subscriptions.*') || request()->is('subscriptions') ? 'active' : '' }}" href="{{ route('front.subscriptions.index') }}" wire:navigate>
